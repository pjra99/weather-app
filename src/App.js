      ...
      <div className="row main-template">
        <div className="col-md-8 left-column">
          <div className="row left-column-upper">
            <div className="col-md-12 date-column">
              {" "}
              <h6 className="date">
                {dateDay} {monthName[dateMonth]}, {weekDay[day]}
              </h6>{" "}
            </div>
          </div>
          <div className="row">
            <div className="col-md-12 left-column-middle"></div>
          </div>
          <div className="row left-column-lower">
            ...
            <div className="col-md-2 weather-location">{search}</div>
        ...
        <div className="col-md-4  right-column">
          <div className="row locations">
            ...
            <ul>
              <li onClick={() => setSearch("Delhi")}>
                <button className="btn">Delhi </button>
              </li>
              <li onClick={() => setSearch("Mumbai")}>
                <button className="btn">Mumbai</button>
              </li>
              <li onClick={() => setSearch("Kolkata")}>
                <button className="btn">Kolkata </button>
              </li>
              <li onClick={() => setSearch("Patna")}>
                <button className="btn">Patna </button>
              </li>
            </ul>
          </div>
          <div className="row weather-details">
            <ul>
              ...
              <li>
                Humidity:{" "}
                {flag === 0 ? <span>_</span> : <span>{city.humidity}</span>}
              </li>
              <li>
                Pressure:{" "}
                {flag === 0 ? <span>_</span> : <span>{city.pressure}</span>}
              </li>
              <li>
                Max Temperature:{" "}
                {flag === 0 ? <span>_</span> : <span>{city.temp_max}</span>}°C
              </li>
              <li>
                Min Temperature:{" "}
                {flag === 0 ? <span>_</span> : <span>{city.temp_min}</span>}°C
              </li>
            </ul>
          </div>
        </div>
